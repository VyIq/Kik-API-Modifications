...
class CheckEmailUniquenessRequest(XMPPElement):
...
class EmailUniquenessResponse(XMPPResponse):
    def __init__(self, data: BeautifulSoup):
        super()__init__(data)
        email_element = data.find('email')
        self.unique = True if email_element['is-unique'] == "true" else False
