...
from kik_unofficial.datatypes.xmpp.sign_up import RegisterResponse, UsernameUniquenessResponse, EmailUniquenessResponse
...
class CheckEmailUniqueResponseHandler(XmmpHandler):
    def handle(self, data: BeautifulSoup):
        self.callback.on_email_uniqueness_received(EmailUniquenessResponse(data))
