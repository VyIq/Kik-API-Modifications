...
class KikClientCallback:
    ...
    def on_email_uniqueness_recieved(self, response: EmailUniquenessResponse):
        """
        Gets called after a call to check_email_uniqueness(), indicating whether or not a requested email was
        found available for registration
        :param response: a EmailUniquenessResponse instance whose 'unique' member is True or False
        """
        pass
